---
title: "Aplha Artefact & User Feedback"
date: "2024-10-30"
...
The artifact is available [here on itch.io](https://boopdood.itch.io/a-walk-in-the-park).
...
1.  It's a very vibrant and colourful park. It's peaceful, and the fact that
    it is interactive is a lot of fun. Rated it down a bit because there
    are some areas which could use some improvement, e.g. lack of audio,
    some glitching with the animations and a river you can fall into with no
    way out.

2.  It's a very vibrant and colourful park. It's peaceful, and the fact that
    it is interactive is a lot of fun. Rated it down a bit because there
    are some areas which could use some improvement, e.g. lack of audio,
    some glitching with the animations and a river you can fall into with no
    way out.
